...
# FIX 1: Added 'r' to the file path
cities = pd.read_csv(r"D:\Documents\Projects\Python\Area and Population\california_cities.csv")
print(cities.head())
...
# FIX 2: Changed plt.axis(aspect='equal') to plt.axis('equal')
plt.axis('equal')

plt.xlabel('Longitude')

# FIX 3: Corrected the Y-axis label
plt.ylabel('Latitude')
